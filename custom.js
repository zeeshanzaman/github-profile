...
function createUserCard(user) {
    ...
    <div>
        <img src="https://randomuser.me/api/protraits/men/30.jpg" alt="" class="avatar">
    </div>
    <div class="user-info">
        <h2>johndoe</h2>
        ...
        <div id="repos">
            <a href="#" class="repose">Repo 1</a>
            <a href="#" class="repose">Repo 2</a>
            <a href="#" class="repose">Repo 3</a>
        </div>
    </div>
</div>`
